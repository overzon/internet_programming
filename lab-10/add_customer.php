...
select:hover{
 ...
 <div>
   <!-- <form action="/action_page.php"> -->
     ...
     <input type="text" id="fname" name="Fname" placeholder="ชื่อ" onblur="checkPrice(this);"><br>
     <label for="lname">Last Name :</label>
     <input type="text" id="lname" name="Lname" placeholder="นามสกุล" onblur="checkPrice(this);">
      <!-- </form> -->
 </div><br>
 ...
 <label>ที่อยู่ : &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<input class="selectpic" type="text" name="address" placeholder="ที่อยู่" onblur="checkPrice(this);"><br><br>
 ...
 <br><br><label>รหัสไปรษณีย์ : &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<input class="selectpic" type="text" name="zipcode" placeholder="รหัสไปรษณีย์" onblur="checkpost(this);" OnKeyPress="return chkNumber(this)">
 <br><label>โทรศัพท์ : &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<input class="selectpic" type="text" name="telephone" placeholder="โทรศัพท์" onblur="checkphone(this);" OnKeyPress="return chkNumber(this)"><br>
 ...
 <label>Username : &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<input type="text" name="user" onblur="checkuser(this);"></label><br>
 <label>Password : &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
 <input type="password" name="pass" id="password" onblur="checkpass(this);"></label><br>
 <label>Re-Password : &nbsp&nbsp&nbsp&nbsp<input type="password" name="confirmpassword" id="confirmpassword" onblur="checkpass(this);"></label><br>
