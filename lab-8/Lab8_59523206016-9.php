...
<bodY>
  <div class="header">
    <H3>ชื่อผู้ใช้ : <?php echo $_SESSION['login_user']; ?> <a style="float:right" href="logout.php">Logout</a></H3>
  </div>
  ...
  <div><div class="colr"><a href="add_customer.php"><img src='edit.png' alt='edit_icon'  style='width:30px;height:30px;' href='edit_customer.php'>เพิ่มข้อมูลของลูกค้า</a></div>
    ...
    if ($result->num_rows > 0) {
        ...
        while($row = $result->fetch_assoc()) {
            ...
            echo "<tr><td style='width: 50px;'>".$counter."</td><td style='width: 250px;'>".$row["Customer_Name"]." ".$row["Customer_Lastname"]."</td><td style='width: 100px;'>".$row["Province"]."</td><td style='width: 100px;'>"
